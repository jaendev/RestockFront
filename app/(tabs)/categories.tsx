...
export default function CategoriesScreen() {
  const categories = [
    { id: 1, name: 'Comida', itemCount: 18, color: '#10B981' },
    { id: 2, name: 'Familia', itemCount: 12, color: '#2563EB' },
    { id: 3, name: 'Limpieza', itemCount: 8, color: '#F59E0B' },
    { id: 4, name: 'Cuidado Personal', itemCount: 15, color: '#8B5CF6' },
    { id: 5, name: 'Cocina', itemCount: 22, color: '#EF4444' },
    { id: 6, name: 'Lavabo', itemCount: 7, color: '#06B6D4' },
    { id: 7, name: 'Oficina', itemCount: 5, color: '#84CC16' },
    { id: 8, name: 'Electronico', itemCount: 9, color: '#F97316' },
  ];
